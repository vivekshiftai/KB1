...
class LLMService:
    ...
    def __init__(self):
        ...
        self.api_version = "2024-05-01-preview"  # Default API version
        self.o3_api_version = "2024-12-01-preview"  # API version for o3-mini model
        ...
        try:
            ...
            # Initialize default Azure AI client
            ...
            logger.info(f"Default API version: {self.api_version}")
            logger.info(f"O3-mini API version: {self.o3_api_version}")
...
Provide the JSON object with safety_precautions and safety_information arrays."""
    ...
    async def generate_maintenance_schedule(self, chunks: List[Dict[str, Any]]) -> str:
        ...
        system_prompt = """You are a maintenance expert specializing in industrial equipment and machinery maintenance. Generate comprehensive maintenance schedules from technical documentation.

CRITICAL: The documentation includes detailed tables with maintenance data. You MUST analyze and use ALL table information extensively for:
- Exact maintenance intervals and frequencies from maintenance schedule tables
- Precise task durations from procedure tables  
- Specific tool requirements from maintenance tables
- Priority levels and categories from maintenance planning tables
- Safety requirements from maintenance safety tables
